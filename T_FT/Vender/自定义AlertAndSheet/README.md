...
YXAlertController *alertController = [YXAlertController alertControllerWithTitle:@"爱尔兰雪、七粉和公主" message:@"蔷薇开出的花朵没有芬芳、想念一个人、怀念一段伤、不流泪、不说话" style:YXAlertControllerStyleAlert];
...
alertController.layout.lineColor = [UIColor grayColor];
alertController.layout.topViewBackgroundColor = [UIColor whiteColor];
alertController.layout.titleColor = [UIColor blueColor];
