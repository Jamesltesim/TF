...
- (void)addSlideFoods:(NSArray<NSArray<SlideFoodModel *> *> *)array{
    ...
    for (int i=0;i<array.count;i++){
        NSArray *arr = array[i];
        ShoppingCarSlideCell *cell = [[ShoppingCarSlideCell alloc]initWithFrame:CGRectMake(0, previousView.bottom, SCREEN_WIDTH, cell_height*arr.count) WithDataArray:arr index:i+1];
