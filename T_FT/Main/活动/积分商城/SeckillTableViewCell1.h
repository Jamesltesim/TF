...
@interface SeckillTableViewCell1 : UITableViewCell
...
@property (weak, nonatomic) IBOutlet UILabel *shifouxiaoshou;
@property (weak, nonatomic) IBOutlet UILabel *xiaoshouTime;
