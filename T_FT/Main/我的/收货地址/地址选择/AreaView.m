...
//    switch (btn.tag) {
//        case 100:{
//            btn2.titleLabel.text = nil;
//
//        }
//        case 101:{
//            btn3.titleLabel.text = nil;
//            break;
//        }
//        case 102:{
//
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    switch (tableView.tag - 200) {
        ...
        {
            AddressAreaModel *addressAreaModel = _provinceArray[indexPath.row];
            btn1Height = [AreaView getLabelWidth:addressAreaModel.sh_name font:15.5 height:30] + 20;
        ...
        {
            AddressAreaModel *addressAreaModel = _cityArray[indexPath.row];
            btn2Height = [AreaView getLabelWidth:addressAreaModel.sh_name font:15.5 height:30] + 20;
        ...
        {
            AddressAreaModel *addressAreaModel = _regionsArray[indexPath.row];
            btn3Height = [AreaView getLabelWidth:addressAreaModel.sh_name font:15.5 height:30] + 20;
    ...
    [UIView animateWithDuration:0.25 animations:^{
        ...
        if ([self.address_delegate respondsToSelector:@selector(getSelectAddressInfor:)]) {
            ...
            if(btn1.titleLabel.text != nil &&
               btn2.titleLabel.text != nil &&
               btn3.titleLabel.text != nil &&
               ![btn1.titleLabel.text isEqualToString:@"请选择"]&&
               ![btn2.titleLabel.text isEqualToString:@"请选择"]&&
               ![btn3.titleLabel.text isEqualToString:@"请选择"]){
                ...
                [self.address_delegate getSelectAddressInfor:@""];
            }
...
+ (CGFloat)getLabelWidth:(NSString *)textStr font:(CGFloat)fontSize height:(CGFloat)labelHeight
{
    ...
    NSDictionary *attribute = @{NSFontAttributeName:  [UIFont fontWithName:@"Helvetica-Light" size:fontSize],NSParagraphStyleAttributeName:paraStyle};
    CGSize size = [textStr boundingRectWithSize:CGSizeMake(1000, labelHeight) options:NSStringDrawingUsesLineFragmentOrigin | NSStringDrawingUsesFontLeading attributes:attribute context:nil].size;
    return size.width;
}
