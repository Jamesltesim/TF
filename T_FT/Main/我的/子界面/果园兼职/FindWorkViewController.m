...
@interface FindWorkViewController ()<UITableViewDelegate,UITableViewDataSource>

@property (nonatomic,strong) NSArray *dataArray;
@property (nonatomic,strong) TBTableView *tabView;
@end
...
- (void)viewDidLoad {
    [super viewDidLoad];
    self.navView.title = @"果园招聘";
    self.tabView = [[TBTableView alloc]initWithFrame:RECT_NAVBAR_AND_NOTABBAR style:UITableViewStylePlain];
    
    self.tabView.delegate = self;
    self.tabView.dataSource = self;
    [self.view addSubview:self.tabView];
    [self.tabView registerNib:[UINib nibWithNibName:@"PartimeTableViewCell" bundle:nil] forCellReuseIdentifier:@"PartimeTableViewCell"];
